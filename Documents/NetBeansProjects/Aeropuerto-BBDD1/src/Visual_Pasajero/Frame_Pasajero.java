 ...
 * @author franc
 */
public class Frame_Pasajero extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Frame_Pasajero.class.getName());

    /**
     * Creates new form Aerolinea
     */
    public Frame_Pasajero() {
        initComponents();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        sustituirPanel(new Nuevo_Pasajero());
        setDefaultCloseOperation(this.DISPOSE_ON_CLOSE);

    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        sustituirPanel(new Panel_Muestra_Datos_Pasajero());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Frame_Pasajero().setVisible(true));
    }
